...
export async function GET() {
  try {
    ...
    // Sem este try/catch a rota devolvia pagina de erro em HTML,
    // e o navegador so dizia "Unexpected end of JSON input".
    console.error('Erro em /api/vagas:', e);
    return NextResponse.json(
      { erro: e.message || 'Falha desconhecida', codigo: e.code || null, vagas: [] },
      { status: 500 },
    );
  }
}
